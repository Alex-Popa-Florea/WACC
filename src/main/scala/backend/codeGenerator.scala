...
object codeGenerator {
    ...
    */
    ...
    def generatePow(dataMap: Map[Scope, Msg], textMap: Map[Scope, ListBuffer[Instruction]]): Unit = {
        ...
        textMap(F(funcName)) = ListBuffer(
            PUSH(List(LR())),
            LDR(None, R(4), ImmediateOffset(SP(), Immed(8))),
            LDR(None, R(5), Immed(0)),
            CMP(None, R(4), R(5)),
            MOV(Some(EQCOND()), false, R(4), Immed(1)),
            MOV(Some(NECOND()), false, R(4), Immed(0)),
            CMP(None, R(4), Immed(0)),
            B(Some(EQCOND()), s"L${scopeLabels}"),
            ...
            LDR(None, R(5), Immed(2)),
            MOV(None, false, R(0), R(4)),
            MOV(None, false, R(1), R(5)),
            BL(None, "p_check_divide_by_zero"),
            BL(None, "__aeabi_idiv"),
            MOV(None, false, R(4), R(0)),
            STR(None, R(4), ImmediateOffset(SP(), Immed(-4))),
            LDR(None, R(4), ImmediateOffset(SP(), Immed(12))),
            STR(None, R(4), ImmediateOffset(SP(), Immed(-4))),
            BL(None, "def_" + funcName),
            ADD(None, false, SP(), SP(), Immed(8)),
            MOV(None, false, R(4), R(0)),
            ...
            MOV(None, false, R(1), R(5)),
            BL(None, "p_check_divide_by_zero"),
            BL(None, "__aeabi_idivmod"),
            MOV(None, false, R(4), R(1)),
            LDR(None, R(5), Immed(0)),
            CMP(None, R(4), R(5)),
            MOV(Some(EQCOND()), false, R(4), Immed(1)),
            MOV(Some(NECOND()), false, R(4), Immed(0)),
            CMP(None, R(4), Immed(0)),
            B(Some(EQCOND()), s"L${scopeLabels + 2}"),
