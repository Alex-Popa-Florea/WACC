...
object operators {
    /*
        Sealed trait to represent operands of certain instructions.
    */
    ...
    */
    ...
    /*
        Sealed trait to represent the addressing modes of certain instructions.
    */
    sealed trait A_mode2

    /*
        Sealed trait to represent offsets of certain instructions.
    */
